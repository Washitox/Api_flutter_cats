        ...
        builder: (context, provider, child) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              Pokemon pokemon = provider.pokemonList[index]; // Aquí usamos la clase Pokemon
              return ListTile(
...
class _CatListScreenState extends State<CatListScreen> {
  ...
  void _fetchCatImages() {
    setState(() {
      _futureCatImages = _catService.fetchCatImages(width: 300, height: 300);
    });
  }
                ...
                children: catImages.map((imageUrl) {
                  return Container(
                    ...
                    child: Image.network(
                      ...
                      fit: BoxFit.cover, // Ajusta la imagen para cubrir todo el espacio disponible sin cortarse
                    ),
                  );
                }).toList(),
              ),
